...
window.__require = (function e(t, n, o) {
...
})(
  {
        ...
        var o = {
          ...
          closeUIAni: function (e, t, n, o) {
            e.runAction(cc.fadeOut(n)),
              t.runAction(
                cc.sequence(
                  cc.scaleTo(n, 0).easing(cc.easeBackIn()),
                  cc.callFunc(o)
                )
              );
          },
          ...
          fireworksAni: function (e, t, n, o) {
            for (var c = 0; c < t; c++) {
              ...
              (a.scale = 0.3 + 0.5 * Math.random()),
                ...
                (a.color = cc.color(
                  this.fireColorArr[
                    this.returnRanNum(0, this.fireColorArr.length - 1)
                  ]
                )),
                e.addChild(a, 88);
          ...
          fireObjAni: function (e, t, n, o) {
            ...
            e.runAction(
              cc.rotateBy(a, this.returnRanNum(-360, 360)).repeatForever()
            );
            ...
            e.runAction(
              cc.sequence(
                cc.delayTime(c),
                cc.jumpBy(s, cc.v2(1.5 * r.x, 0), n, 1),
                cc.removeSelf(!0)
              )
            );
          },
          bombObjAni: function (e, t, n, o, c, a) {
            ...
            e.runAction(
              cc.sequence(
                cc.spawn(
                  cc.scaleTo(s + 0.1, l),
                  cc.moveBy(s, r).easing(cc.easeQuadraticActionOut()),
                  cc.fadeTo(s + 0.1, u)
                ),
                cc.fadeOut(0.1),
                cc.removeSelf(!0)
            ...
            return (
              ...
              (t.prototype.onLoad = function () {
                null != n.Instance && n.Instance.destroy(),
                  (n.Instance = this),
                  (n.Instance.playerData = JSON.parse(
                    cc.sys.localStorage.getItem(this.gameName + "playerData11")
                  )),
              ...
              (t.prototype.Save = function () {
                cc.sys.localStorage.setItem(
                  this.gameName + "playerData11",
                  JSON.stringify(n.Instance.playerData)
                );
              }),
              (t.Instance = null),
            ...
            return (
              ...
              (t.prototype.LightOEffect = function (e) {
                ...
                (t.position = e),
                  (t.scale = 0.2),
                  t.runAction(
                    cc.sequence(cc.scaleTo(0.3, 1.2), cc.fadeOut(0.3))
                  ),
                  t.children[0].runAction(
                    cc.spawn(cc.moveBy(0.5, -65, 65), cc.fadeOut(0.6))
                  ),
                  t.children[1].runAction(
                    cc.spawn(cc.moveBy(0.5, 65, -65), cc.fadeOut(0.6))
                  ),
                  t.children[2].runAction(
                    cc.spawn(cc.moveBy(0.5, -65, -65), cc.fadeOut(0.6))
                  ),
                  t.children[3].runAction(
                    cc.spawn(cc.moveBy(0.5, 65, 65), cc.fadeOut(0.6))
                  );
              }),
              (t.prototype.MilkEffect = function (e, t) {
                ...
                (n.color = new cc.Color().fromHEX(
                  ...
                  (n.position = e),
                  (n.scale = 0.3),
                  n.runAction(cc.sequence(cc.scaleTo(0.3, 1), cc.fadeOut(0.3)));
              }),
              (t.prototype.FireLight = function () {
                this.fireLightNode.stopAllActions(),
                  ...
                  this.fireLightNode.runAction(
                    cc.sequence(
                      cc.fadeTo(0.11, 180).easing(cc.easeCubicActionIn()),
                      cc.fadeTo(0.18, 0)
                    )
                  );
              }),
              (t.prototype.SendGoldCoin = function (e, t, n) {
                ...
                o = e;
                for (
                  var c = a.default.ConvertPosition(t, this.uiEffectParent),
                    r = a.default
                      .ConvertPosition(n, this.uiEffectParent)
                      .sub(cc.v2(0, 0)),
                    s = 0;
                  s < o;
                  s++
                  ...
                  var u = c.add(
                    ...
                    d = cc.jumpTo(0.3, u, a.default.Random(30, 150), 1),
                    p = cc.sequence(
                      d,
                      cc.moveBy(0.06, cc.v2(0, 10)),
                      cc.moveBy(0.06, cc.v2(0, -10))
                    ),
                    f = r.sub(c),
                    h =
                      ...
                      cc.v2(r)),
                    m = cc.moveTo(0.3, h).easing(cc.easeBackIn());
                  l.runAction(
                    cc.sequence(
                      p,
                      cc.delayTime(0.05),
              ...
              (t.prototype.SendGoldCoin2 = function (e, t) {
                for (
                  var n = Math.floor(a.default.Random(5, 8)),
                    o = a.default.ConvertPosition(e, this.uiEffectParent),
                    c = a.default
                      .ConvertPosition(t, this.uiEffectParent)
                      .sub(cc.v2(0, 0)),
                    r = 0;
                  r < n;
                  r++
              ...
              (t.prototype.BloodBoom = function (e, t, n) {
                for (var o = a.default.RandomInteger(t, n), c = 0; c < o; c++) {
                  ...
                  r.runAction(
                    ...
                    r.runAction(
                      cc.sequence(cc.delayTime(0.5 * l), cc.fadeOut(0.5 * l))
                    );
                }
              }),
              (t.prototype.StepCloud = function (e, t) {
                for (var n = a.default.RandomInteger(3, 6), o = 0; o < n; o++) {
                  ...
                  (c.node.scale = a.default.Random(0.2 * s, 0.6 * s)),
                  ...
                  c.node.runAction(
                    cc.sequence(cc.delayTime(0.2), cc.fadeOut(0.3))
                  ),
                    c.node.runAction(
                      cc.sequence(
                        cc.moveBy(0.5, l),
              ...
              (t.prototype.EnemyDeadEFF = function (e) {
                for (
                  var t = a.default.RandomInteger(10, 15), n = 0;
                  n < t;
                  n++
                ) {
                  var o = i.default
                  ...
                  32,
                    ...
                    (o.node.scale = a.default.Random(0.5, 1.5));
                  var s = cc.v2(0, 1);
                  ...
                  o.node.runAction(
                    cc.sequence(
                      cc.delayTime(0.2 * u),
                      cc.scaleTo(0.8 * u, a.default.Random(0.1, 0.3))
                    )
                  ),
                    o.node.runAction(
                      cc.sequence(
                        cc.moveBy(u, s.mul(l)).easing(cc.easeCubicActionOut()),
                        cc.callFunc(function (e) {
                          i.default.Despawn("EffectSprite", e);
                        }, this)
                      )
                ...
                (d.node.parent = this.downEffectPartiParent),
                  ...
                  (d.node.position = e),
                  d.SetSprite(
                    r.default.Instance.GetSpriteFrame("whiteCircle"),
                    cc.v2(150, 150)
                  ),
                  (d.node.opacity = 200),
                  (d.node.scale = 0),
                  d.node.runAction(cc.scaleTo(0.32, 1)),
                  d.node.runAction(
                    cc.sequence(
                      cc.delayTime(0.2),
                      cc.fadeOut(0.1),
              ...
              (t.prototype.StarFishDead = function (e) {
                for (
                  var t = a.default.RandomInteger(20, 26), n = 0;
                  n < t;
                  n++
                ) {
                  var o = i.default
                  ...
                  32,
                    o.SetSprite(c, cc.v2(32, 32)),
                    (o.node.scale = a.default.Random(0.3, 1.6));
                  var s = cc.v2(0, 1);
                  s.rotateSelf(a.default.AngleToRadian(360 * Math.random()));
                  ...
                  o.node.runAction(
                    cc.sequence(
                      cc.delayTime(u * a.default.Random(0.1, 0.3)),
                      cc.scaleTo(0.8 * u, a.default.Random(0.1, 0.3))
                    )
                  ),
                    o.node.runAction(
              ...
              (t.prototype.PutEFF = function (e, t) {
                for (
                  var n = a.default.RandomInteger(15, 20), o = 0;
                  o < n;
                  o++
                ) {
                  ...
                  s.SetSprite(l, cc.v2(18, 18)),
                    c.setPosition(
                      e.x + 80 * Math.random() - 40,
                      e.y + 80 * Math.random() - 40
                    ),
                    c.setScale(0.5 * Math.random() + 0.5),
                  ...
                  c.runAction(
                    cc.sequence(
                      cc.spawn(
                        cc.moveTo(0.8, p).easing(cc.easeCircleActionOut()),
                        cc
                          .scaleTo(0.8 * a.default.Random(0.5, 1), 0)
                          .easing(cc.easeCircleActionIn())
                      ),
                      cc.callFunc(function (e) {
                        i.default.Despawn("EffectSprite", e);
                      }, this)
              ...
              (t.prototype.LevelUpEff = function (e, t) {
                for (
                  var n = a.default.RandomInteger(27, 36), o = 0;
                  o < n;
                  o++
                ) {
                  var c = i.default.Spawn("EffectSprite");
                  ...
                  s.SetSprite(l, cc.v2(32, 32)),
                    c.setPosition(
                      e.x + 90 * Math.random() - 45,
                      e.y + 90 * Math.random() - 45
                    ),
              ...
              (t.prototype.PortDownEff = function (e) {
                for (
                  var t = a.default.RandomInteger(12, 15), n = 0;
                  n < t;
                  n++
                ) {
                  var o = i.default
                  ...
                  (o.node.parent = this.downEffectPartiParent),
                    o.Reset(),
                    o.SetSprite(
                      r.default.Instance.GetSpriteFrame("ball"),
                      cc.v2(48, 48)
                    ),
                    (o.node.scale = a.default.Random(0.6, 1)),
                  ...
                  var c = cc
                      ...
                      .rotate(
                        a.default.AngleToRadian(a.default.Random(0, 360))
                      ),
                    s = cc.moveBy(0.7, c),
                    l = cc.scaleTo(0.6, 0),
                    u = cc.fadeOut(0.5);
                ...
                for (var t = 0; t < e.length; t++) {
                  ...
                  for (var o = 0; o < 40; o++) {
                    ...
                    (c.position = cc.v2(e[t][0], e[t][1])),
                      (c.scale = a.default.Random(0.7, 1)),
                      (c.getComponent(cc.Sprite).spriteFrame =
                        s.default.Instance.caidia[
                          a.default.RandomInteger(0, 6)
                        ]);
                    var r = c.position,
                      u =
                        r.x +
                        ...
                        cc.spawn(
                          ...
                          cc
                            .moveBy(
                              ...
                              1.2 *
                                -cc.winSize.height *
                                a.default.Random(0.8, 1.2)
                            )
                            .easing(cc.easeCubicActionIn()),
                          cc.moveBy(2.8, a.default.Random(0, -300) * n, 0),
                          cc.rotateBy(
                            2,
                            a.default.Random(360, 720) *
                              (2 * Math.round(Math.random()) - 1)
                          ),
                          cc.sequence(
                            cc.moveBy(
                              2 * (0.1 * Math.random() + 0.3),
                              (25 * Math.random() + 25) *
                                (2 * Math.round(Math.random()) - 1),
                              0
                            ),
                ...
                for (
                  var t = function (t) {
                      ...
                      (o.node.parent = n.bgEffectParent),
                        ...
                        o.Reset(),
                        o.SetSprite(
                          r.default.Instance.GetSpriteFrame("star"),
                          cc.v2(32, 32)
                        ),
                        (o.node.color = new cc.Color(254, 236, 180));
                      var c = cc
                        .v2(0, 100)
                        .rotate(a.default.AngleToRadian(30 * t));
                      o.node.runAction(
                        cc.sequence(
                          cc.moveBy(0.45, c),
                          cc.callFunc(function () {
                        ...
                        o.node.runAction(cc.rotateBy(0.45, 360)),
                        o.node.runAction(
                          cc.sequence(
                            cc.delayTime(0.225),
                            cc.scaleTo(0.225, 0.4)
                          )
                        );
                    },
                    n = this,
              ...
              (t.prototype.GhostBornEff = function (e) {
                for (
                  var t = a.default.RandomInteger(100, 101), n = 0;
                  n < t;
                  n++
                ) {
                  var o = i.default
                  ...
                  o.node.runAction(
                    ...
                    o.node.runAction(
                      cc.sequence(
                        cc.delayTime(d),
                        cc.fadeTo(0.1, a.default.Random(120, 240))
                      )
                    ),
                    o.node.runAction(
                      cc.sequence(
              ...
              (t.prototype.LittleFly = function (e) {
                for (
                  var t = a.default.RandomInteger(24, 33), n = 0;
                  n < t;
                  n++
                ) {
              ...
              (t.prototype.JuiceBoom = function (e, t) {
                for (var n = 0; n < 6; n++) {
                  ...
                  var c = cc.v2(0, 1);
                  c = c.rotate(
                    a.default.AngleToRadian(a.default.Random(-60, 60))
                  );
                  var r = a.default.Random(60, 100),
                    s = cc.moveBy(0.3, c.mul(r));
                  o.runAction(s),
                    o.runAction(
                      cc.sequence(
                        cc.delayTime(0.05),
                        cc.scaleTo(0.25, a.default.Random(0.1, 0.2))
                      )
                    ),
                    o.runAction(
                      cc.sequence(cc.delayTime(0.2), cc.fadeOut(0.1))
                    );
                }
              }),
              (t.prototype.createBlood = function (e) {
                for (var t = 0; t < 3; t++) {
                  ...
                  o.Reset(),
                    ...
                    (o.node.color = new cc.Color().fromHEX("#AD0909")),
                    n.setContentSize(
                      a.default.RandomInteger(16, 18),
                      a.default.RandomInteger(16, 18)
                    ),
                    n.runAction(
                      cc.sequence(
                    ...
                    n.runAction(
                      cc.sequence(
                        cc.delayTime(0.4 * t),
                        cc.scaleTo(0.3, 1),
                        cc.moveBy(0.6, cc.v2(0, -180)),
                        cc.callFunc(function () {}, n)
                      )
                    );
                }
              }),
              (t.prototype.LightBoomAndMove = function (e, t) {
                for (
                  var n = a.default.RandomInteger(32, 43), o = 0;
                  o < n;
                  o++
                ) {
                  ...
                  c.runAction(
                    cc.sequence(
                      cc.delayTime(u),
                      cc.delayTime(l * a.default.Random(0.1, 0.3)),
                      cc.scaleTo(0.8 * l, a.default.Random(0.2, 0.3))
                    )
                  ),
                    (c.opacity = 0),
                    c.runAction(
                      cc.sequence(
                        cc.delayTime(u),
                        cc.fadeTo(0.08, a.default.Random(160, 240))
                      )
                    ),
                    c.runAction(
                      cc.sequence(
                        cc.delayTime(u),
                        cc.moveBy(l, r.mul(s)).easing(cc.easeCubicActionOut()),
                        cc.callFunc(function (e) {
                          e.stopAllActions(), e.destroy();
                        }, this)
                      )
                  ...
                  c.runAction(
                    cc.sequence(
                      cc.delayTime(u),
                      cc.rotateBy(l, a.default.Random(180, 200) * d)
                    )
                  );
                }
              }),
              (t.prototype.RecoveryPigment = function (e) {
                for (var t = a.default.RandomInteger(6, 7), n = 0; n < t; n++) {
                  ...
                  o.SetSprite(c, cc.v2(40, 40)),
                    (o.node.position = e.add(
                      cc.v2(
                        a.default.Random(-55, 55),
                        a.default.Random(-15, 40)
                      )
                    ));
                  var s = a.default.Random(0.4, 1),
              ...
              (t.prototype.WinkJump = function (e) {
                for (
                  var t = a.default.RandomInteger(16, 17), n = 0;
                  n < t;
                  n++
                ) {
                  var o = i.default
                  ...
                  (o.node.parent = this.upEffectPartiParent),
                    o.Reset(),
                    o.SetSprite(
                      r.default.Instance.GetSpriteFrame("wink"),
                      cc.v2(110, 110)
                    ),
                    (o.node.scale = a.default.Random(0.3, 1.2)),
                    (o.node.opacity = a.default.RandomInteger(170, 250)),
                    (o.node.position = e.add(
                      cc.v2(
                        a.default.Random(-30, 30),
                        a.default.Random(-30, 30)
                      )
                    ));
                  var c = cc.v2(
                    a.default.Random(-150, 150),
                    a.default.Random(20, -60)
                  );
              ...
              (t.prototype.RightSelect = function (e, t) {
                for (
                  var n = a.default.RandomInteger(20, 23), o = 0;
                  o < n;
                  o++
                ) {
                  var c = i.default
                  ...
                  64,
                    ...
                    (c.node.scale = a.default.Random(0.3, 1.6));
                  var l = cc.v2(0, 1);
                  ...
                  (p = a.default.Random(0.005, 0.015) * o),
                    c.node.runAction(
                      cc.sequence(
                        cc.delayTime(p),
                        cc.delayTime(d * a.default.Random(0.1, 0.3)),
                        cc.scaleTo(0.8 * d, a.default.Random(0.2, 0.3))
                      )
                    ),
                    (c.node.opacity = 0),
                    c.node.runAction(
                    ...
                    c.node.runAction(
                      cc.sequence(
                        cc.delayTime(p),
                        cc.moveBy(d, l.mul(u)).easing(cc.easeCubicActionOut()),
                        cc.callFunc(function (e) {
                          i.default.Despawn("EffectSprite", e);
                        }, this)
                      )
                  ...
                  c.node.runAction(
                    cc.sequence(
                      cc.delayTime(p),
                      cc.rotateBy(d, a.default.Random(220, 260) * f)
                    )
                  );
                }
              }),
              (t.prototype.ShowLandParti = function (e, t) {
                for (
                  var n = t,
                    o = [cc.v2(e.x - 8, e.y + 50), cc.v2(e.x + 8, e.y + 50)],
                    c = 0;
                  c < o.length;
                  c++
                ) {
                  ...
                  for (var s = 0; s < n; s++) {
                    ...
                    (l.parent = this.upEffectPartiParent),
                      l.stopAllActions(),
                      (l.opacity = 255),
                      (l.scale = a.default.Random(0.5, 1));
                    var u = o[c];
                    l.setPosition(u);
                    var d = cc.v2(
                        a.default.RandomInteger(0, 80) * r,
                    ...
                    l.runAction(
                      cc.sequence(
                        cc.spawn(
                          cc.sequence(
                            cc.jumpBy(12 / f, d, f, 1),
                            cc.moveBy(5 / f, cc.v2(0, 0))
                          ),
                          cc.rotateTo(15 / f, p)
                        ),
                        cc.callFunc(function (e) {}, this)
                      )
                    );
                  }
                }
              ...
              (t.prototype.ShowLandParti1 = function (e, t) {
                for (
                  var n = t,
                    o = [cc.v2(e.x - 8, e.y), cc.v2(e.x + 8, e.y)],
                    c = 0;
                  c < o.length;
                  c++
                ) {
                  ...
                  for (var s = 0; s < n; s++) {
                    ...
                    (l.parent = this.upEffectPartiParent),
                      l.stopAllActions(),
                      (l.opacity = 255),
                      (l.scale = a.default.Random(0.2, 0.5));
                    var u = o[c];
                    l.setPosition(u);
                    var d = cc.v2(
                        a.default.RandomInteger(0, 80) * r,
              ...
              (t.prototype.GhostTouchPlayer = function (e) {
                for (
                  var t = [cc.v2(e.x - 40, e.y), cc.v2(e.x + 40, e.y)], n = 0;
                  n < t.length;
                  n++
                ) {
                  ...
                  for (var c = 0; c < 15; c++) {
                    ...
                    l.SetSprite(r.default.Instance.GetSpriteFrame("ball"), u),
                      ...
                      s.stopAllActions(),
                      (s.opacity = 255),
                      (s.scale = a.default.Random(0.6, 1));
                    var d = t[n];
                    s.setPosition(d);
                    var p = cc.v2(
                        a.default.RandomInteger(-5, 54) * o,
                    ...
                    s.runAction(
                      cc.sequence(
                        cc.spawn(
                          cc.sequence(
                            cc.jumpBy(12 / h, p, h, 1),
                            cc.spawn(
                              cc.moveBy(5 / h, cc.v2(0, -30)),
                              cc.fadeOut(5 / h)
                            )
                          ),
                          cc.rotateTo(15 / h, f)
              ...
              c([p(cc.Node)], t.prototype, "downEffectPartiParent", void 0),
          ...
          l = (function (e) {
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                this.stateCheck &&
                  null != this.camera &&
                  (!this.startWork && this.InScreen() && (this.startWork = !0),
                  this.startWork &&
                    !this.InScreen() &&
                    a.default.Despawn("EffectSprite", this.node));
              }),
              (t.prototype.Reset = function () {
                (this.startWork = !1),
                  ...
                  (this.node.getComponent(cc.Sprite).sizeMode =
              ...
              (t.prototype.InScreen = function () {
                ...
                return (
                  this.node.x < e + this.node.width / 2 &&
                  this.node.x > t - this.node.width / 2 &&
                  this.node.y < n + this.node.height / 2 &&
                  this.node.y > o + this.node.height / 2
                );
              }),
          ...
          p = (function (e) {
            ...
            return (
              ...
              (t.prototype.onLoad = function () {
                null != n.Instance && n.Instance.destroy(),
                  (n.Instance = this),
                  this.clickMask.setContentSize(
                    cc.winSize.width,
                    cc.winSize.height
                  ),
                  this.bgMask.setContentSize(
                    cc.winSize.width,
                    cc.winSize.height
                  ),
                  (this.failedUiBox.y =
                    cc.winSize.height / 2 + this.failedUiBox.height / 2);
              }),
              (t.prototype.start = function () {
                ...
                1 != e &&
                  ((this.bencichengji.getComponent(
                    cc.Sprite
                  ).spriteFrame = this.bencichengjiarr[e - 1]),
                  (this.gengduoyouxi.getComponent(
                    cc.Sprite
                  ).spriteFrame = this.gengduoyouxiarr[e - 1])),
                  (this.continueTip.getComponent(cc.Label).string =
                    1 == e
                      ? "\u70b9\u51fb\u7ee7\u7eed"
                      : 2 == e
                      ? "\u9ede\u64ca\u7e7c\u7e8c"
              ...
              (t.prototype.ShowFailedUi = function (e, t) {
                ...
                this.scheduleOnce(function () {
                  r.default.Instance.HideScorePanel(),
                    (n.levelTxt.string = r.default.Instance.level.toString()),
                    ...
                    (n.overTxt.string =
                      ...
                      Math.floor(
                        (r.default.Instance.nowYQ /
                          r.default.Instance.passlevelYQ) *
                          100
                      ) +
                      "%"),
                    (n.canClick = !1),
                    (n.levelTxt.string = e),
                    n.bgMask.runAction(cc.fadeTo(0.36, 150)),
                    n.scheduleOnce(function () {
                      i.default.CenteredUi(
                        ...
                        this.failedUiBox.runAction(
                          cc.sequence(
                            cc
                              .moveTo(0.36, this.failedBoxPos)
                              .easing(cc.easeBackOut()),
                            cc.callFunc(function () {
                              this.clickMask.on(
                                cc.Node.EventType.TOUCH_START,
                                this.OnClickCloseMask,
                                this
                              ),
                                this.moreGameBtn.on(
                                  cc.Node.EventType.TOUCH_START,
              ...
              (t.prototype.OnClickCloseMask = function () {
                this.canClick &&
                  0 == cc.find("Canvas/uiEffectPanel").childrenCount &&
                ...
                return (
                  ...
                  [
                    ...
                    "\u64ca\u6557\u4e86\u5168\u7403" +
                      n +
                      "%\u7684\u73a9\u5bb6\uff01",
                    "Beat " + n + " % of global players",
                    "\uc804 \uc138\uacc4" +
                      n +
                      "% \uc758 \uc720 \uc800 \ub97c \uc774 \uacbc \uc2b5 \ub2c8 \ub2e4",
                  ][i.default.returnCurrentLanType() - 1]
                );
              }),
              (t.Instance = null),
              ...
              c([d(cc.Node)], t.prototype, "adsButton2", void 0),
              c([d(cc.Node)], t.prototype, "bannerButton", void 0),
              (t = n = c([u], t))
            );
          })(cc.Component);
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                a.default.GameUpdateCtrl,
                  this.lineNode.children[0].y - n.Instance.fruitHeigth < 100 &&
                    this.lineNode.children[0].y - n.Instance.fruitHeigth >= 0 &&
                  ...
                  for (
                    var t = 0,
                      n = function (n) {
                        setTimeout(function () {
                          e.createFruitL(
                            e.fruitNode.children[n].getComponent("fruitData")
                              .fruitNumber,
                            e.fruitNode.children[n].position,
                            e.fruitNode.children[n].width
                          ),
                            (a.default.score +=
                              e.fruitNode.children[n].getComponent("fruitData")
                                .fruitNumber + 1),
              ...
              (t.prototype.testEnd = function () {
                var e = this;
                if (
                  this.lineNode.children[0].y - n.Instance.fruitHeigth < -20 &&
                  0 == this.endOne
                ) {
                  for (var t = 0; t < this.fruitNode.children.length; t++)
                    this.fruitNode.children[t].removeComponent(
                  ...
                  for (
                    var o = function (t) {
                        setTimeout(function () {
                          e.createFruitL(
                            e.fruitNode.children[t].getComponent("fruitData")
                              .fruitNumber,
                            e.fruitNode.children[t].position,
                            e.fruitNode.children[t].width
                          ),
                            (a.default.score +=
                              e.fruitNode.children[t].getComponent("fruitData")
                                .fruitNumber + 1),
              ...
              (t.prototype.findHighestFruit = function () {
                for (
                  ...
                  var n =
                    ...
                    this.fruitNode.children[t].width / 2;
                  e < n && (e = n);
                }
                return e;
              }),
              ...
              (t.prototype.createOneFruit = function (e) {
                ...
                (n.parent = this.lineNode),
                  ...
                  (n.children[0].getComponent(cc.Sprite).spriteFrame =
                    d.default.Instance.fruit[e]),
              ...
              (t.prototype.createLevelUpFruit = function (e, t) {
                ...
                (o.parent = this.fruitNode),
                  ...
                  (o.children[0].getComponent(cc.Sprite).spriteFrame =
                    d.default.Instance.fruit[e]),
                  (o.getComponent("fruitData").fruitNumber = e),
                  (o.position = t),
                  (o.scale = 0),
                  ...
                  cc
                    ...
                    .call(function () {
                      null != o.getComponent(cc.PhysicsCircleCollider) &&
                        ((o.getComponent(cc.PhysicsCircleCollider).radius =
                          o.height / 2),
                        (o.getComponent(cc.RigidBody).type =
              ...
              (t.prototype.createFruitL = function (e, t, n) {
                u.default.Instance.Play(3, !1, 0.5),
                  u.default.Instance.Play(6, !1, 0.3);
                for (var o = 0; o < 10; o++) {
                  var c = r.default.Spawn("juicePre", this.downEffect);
                  c.getComponent(cc.Sprite).spriteFrame =
                    d.default.Instance.fruitL[e];
                    ...
                    c.runAction(
                      cc.sequence(
                        cc.spawn(
                          ...
                          cc.rotateBy(
                            p + 0.5,
                            s.default.RandomInteger(-360, 360)
                          )
                        ),
                        cc.fadeOut(0.1),
                        cc.callFunc(function () {
                ...
                (m.getComponent(cc.Sprite).spriteFrame =
                  ...
                  m.runAction(
                    cc.sequence(
                      cc.spawn(cc.scaleTo(0.2, n / 150), cc.fadeOut(1)),
                      cc.callFunc(function () {
                        m.active = !1;
                      })
                    )
              ...
              (t.prototype.levelUpEffect = function () {
                for (var e = 0; e < 25; e++) {
                  ...
                  (t.scale = 0.3 * Math.random() + 0.2), (t.opacity = 210);
                  ...
                  cc.tween(t)
                    .to(
                      0.8,
                      {
                        ...
                        opacity: s.default.getRandomNum(0.4, 0.8),
                      },
                      {
                        easing: "cubicOut",
                      }
              ...
              (t.prototype.conboHit = function (e) {
                var t = this;
                u.default.Instance.Play(5, !1, 0.5);
                  ...
                  n.runAction(
                    cc.sequence(
                      cc.spawn(
                        ...
                        cc.rotateBy(0.3, 720),
                        cc.callFunc(function () {
                          t.getScore(10 * e, cc.v2(0, -200), 0.8, 0.5);
                        })
                      ),
                      cc.fadeOut(0.5)
                    )
              ...
              (t.prototype.ribbonEffect = function (e) {
                ...
                for (
                  var t = s.default.getRandomNum(80, 100), n = 0;
                  n < t;
                  n++
                ) {
                  ...
                  o.runAction(
                    cc.sequence(
                      cc.spawn(
                        ...
                        cc.sequence(
                          cc.delayTime(0.17 * s.default.getRandomNum(20, 24.5)),
                          cc.fadeOut(0.17)
                        )
                      ),
                      cc.removeSelf(!0)
              ...
              (t.prototype.ShowLandParti = function (e, t) {
                for (
                  var n = t,
                    o = [
                      cc.v2(e.position.x - 8, e.position.y),
                      cc.v2(e.position.x + 8, e.position.y),
                    ],
                    c = 0;
                  c < o.length;
                  ...
                  for (
                    var i = function () {
                        ...
                        t.setPosition(n);
                        var i = cc.v2(
                            s.default.getRandomNum(0, 400, !0) * a,
                            -s.default.getRandomNum(300, 500, !0)
                          ),
                        ...
                        t.runAction(
                          cc.sequence(
                            cc.spawn(
                              cc.sequence(
                                cc.jumpBy(
                                  s.default.RandomInteger(1500, 1700) / p,
                                  i,
                                  p,
                                  1
                                ),
                                cc.spawn(
                                  cc.moveBy(50 / p, cc.v2(0, -30)),
                                  cc.fadeOut(50 / p)
                                )
                              ),
                              cc.scaleTo(
                                s.default.RandomInteger(1500, 1700) / p,
                                s.default.getRandomNum(0.4, 0.7, !1)
                              ),
                              cc.rotateTo(
                                s.default.RandomInteger(1500, 1700) / p,
                                u / 2
              ...
              return (
                ...
                (t.prototype.onLoad = function () {
                  null != n.Instance && n.Instance.destroy(),
                    ...
                    cc
                      .find("Canvas/bgLayer")
                      .setContentSize(cc.winSize.width, cc.winSize.height);
                }),
                (t.prototype.start = function () {
      ...
      function (e, t, n) {
        ...
        var o = {
          ...
          setNodeSpriteFrame: function (e, t) {
            e.getComponent(
              cc.Sprite
            ).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(t);
          },
          ...
          loadingScene: function (e, t) {
            t
              ? cc.loader.loadRes("panel/LoadingLayer", function (t, n) {
          ...
          i =
            ...
            c(o, "onErrorHandler", function () {
              cc.log("\u7f51\u7edc\u9519\u8bef"),
                (this.isBusy = !1),
                this.perform.target
                  ? this.perform.func.call(this.perform.target, -1)
                  : this.perform.func(-1);
            }),
        ...
        var a = e("./GameFunction"),
          ...
          p = (function (e) {
            ...
            return (
              ...
              (t.prototype.start = function () {
                this.openTouch(),
                  (this.RockerJS = this.Rocker.getComponent("Rocker"));
              }),
              (t.prototype.update = function (e) {}),
              ...
              (t.prototype.onTouchStart = function (e) {
                if (
                  ...
                  cc.tween(a.default.Instance.targetFruit)
                    .to(0.1, {
                      position: cc.v2(t, n),
                    })
                    .start();
              ...
              (t.prototype.onTouchEnd = function (e) {
                ...
                i.default.playerTouch &&
                  ...
                  (a.default.Instance.targetFruit.getComponent(
                    cc.PhysicsCircleCollider
                  ).radius = a.default.Instance.targetFruit.height / 2),
                  ...
                  this.scheduleOnce(function () {
                    i.default.GameUpdateCtrl &&
                      (0 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(0),
                          t.createFruitCount++)
                        : 1 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(0),
                          t.createFruitCount++)
                        : 2 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(1),
                          t.createFruitCount++)
                        : 3 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(2),
                          t.createFruitCount++)
                        : 4 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(2),
                          t.createFruitCount++)
                        : 5 == t.createFruitCount
                        ? (a.default.Instance.createOneFruit(3),
                          t.createFruitCount++)
                        : t.createFruitCount > 5 &&
                          (a.default.Instance.createOneFruit(
                            s.default.RandomInteger(0, 5)
                          ),
                          t.createFruitCount++));
                  }, 0.5));
              }),
              ...
              (t.prototype.addScore = function () {
                ...
                (e.position = cc.v2(0, 200)),
                  ...
                  e.runAction(
                    cc.sequence(
                      cc.spawn(cc.scaleTo(0.5, 1), cc.moveBy(0.5, 0, 200)),
                      cc.fadeOut(0.5),
                      cc.callFunc(function () {
              ...
              c([d(cc.Node)], t.prototype, "stick", void 0),
              c([d], t.prototype, "Max_r", void 0),
              c([d(cc.Node)], t.prototype, "Arrow", void 0),
              c([d(cc.Node)], t.prototype, "knife", void 0),
              (t = n = c([u], t))
            );
          })(cc.Component);
        (n.default = p), cc._RF.pop();
        ...
        var a = e("../common/PlayerInfo"),
          ...
          g = (function (e) {
            function t() {
              var t = (null !== e && e.apply(this, arguments)) || this;
              return (
                (t.starPre = null), (t.Arrow = null), (t.prefabStrArr = []), t
              );
            }
            ...
            return (
              ...
              (t.prototype.onCollisionEnter = function (e, t) {
                if ("bazi" == e.node.group) {
                  ...
                  if (
                    ...
                    e.node.removeComponent(cc.PolygonCollider),
                    t.node.stopAllActions(),
                    (a.default.knifeLR = t.node.x > 0 ? 1 : -1),
                    (t.node.children[1].scaleX = -a.default.knifeLR),
                    this.great(t.node, e.node),
                    i.default.Instance.CameraAoto(),
                    i.default.Instance.CreateBazi(a.default.knifeLR),
                    -1 == a.default.knifeLR)
                  )
                    ((n = r.default.Spawn(
                      "arrowL",
                  ...
                  for (
                    var o = 0;
                    o < cc.find("Canvas/baziNode").children.length;
                    o++
                  )
                    cc.find("Canvas/baziNode").children[o].stopAllActions();
              ...
              (t.prototype.great = function (e, t) {
                if (Math.abs(e.y - t.y) <= 15) {
                  p.default.Instance.Play(1, !1, 1),
                    (a.default.tuoweiCtrl = !0),
                    d.default.Instance.InjuredEffect();
                  var n = r.default.Spawn(
                    "great",
                  ...
                  e.x > 0
                    ...
                    n.runAction(
                      cc.sequence(
                        cc.spawn(cc.moveBy(0.4, 0, 200), cc.rotateBy(0.4, 360)),
                        cc.scaleTo(0.15, 1.1),
                        cc.scaleTo(0.15, 1),
                        cc.fadeOut(0.2)
                      )
                    ...
                    (a.default.score += 10),
                    d.default.Instance.SetScoreTween(a.default.score);
                } else
                  p.default.Instance.Play(0, !1, 1),
                    (a.default.score += 5),
                    d.default.Instance.SetScoreTween(a.default.score);
              ...
              (t.prototype.GhostBornEff = function (e, t) {
                for (
                  var n = s.default.RandomInteger(24, 36), o = 0;
                  o < n;
                  o++
                ) {
                  ...
                  c.runAction(
                    ...
                    c.runAction(
                      cc.sequence(
                        cc.delayTime(u),
                        cc.fadeTo(0.1, s.default.Random(120, 240))
                      )
                    ),
                    c.runAction(
                      cc.sequence(
                        cc.delayTime(u),
                        cc.moveBy(l, a.mul(i)).easing(cc.easeCubicActionOut()),
                        cc.callFunc(function (e) {
              ...
              (t.prototype.createLizi = function (e, t) {
                for (var n = 0; n < 10; n++) {
                  ...
                  (o.scale = 0.1 * t),
                    ...
                    1 == t && (o.color = new cc.Color().fromHEX("ffc049"));
                  var c = new Array();
                  c.push(-360, 360),
                    o.runAction(
                      cc.sequence(
                        cc.spawn(
                          cc.jumpBy(
                            0.5,
                            s.default.RandomInteger(-100, 100),
                            s.default.RandomInteger(-200, -100),
                            s.default.RandomInteger(0, 50),
                            1
                          ),
                          cc.rotateTo(0.5, s.default.RandomIndexFromArr(c)),
                          cc.fadeOut(0.5)
                        ),
                        cc.delayTime(0.1)
                      )
              ...
              (t.prototype.createWord = function (e) {
                var t = r.default.Spawn(
                  "star",
                  cc.find("Canvas/upEffectParent")
                );
                (t.position = s.default.convetOtherNodeSpaceAR(
                  this.node,
                  cc.find("Canvas/upEffectParent")
                )),
                  2 == e
              ...
              (t.prototype.createStar = function () {
                ...
                e.scale = s.default.Random(0.1, 1);
                var t = this.node.x + this.node.width / 2,
                  n = this.node.x - this.node.width / 2,
                  o = this.node.y;
                (e.position = cc.v2(s.default.RandomInteger(n, t), o)),
              ...
              (t.prototype.planeBoomEffect = function () {
                r.default.Spawn(
                  "boom",
                  cc.find("Canvas/upEffectParent")
                ).position = s.default.convetOtherNodeSpaceAR(
                  this.node,
                  cc.find("Canvas/upEffectParent")
                );
              }),
                ...
                for (var n = 0; n < 3; n++)
                  setTimeout(function () {
                    ...
                    (t.position = e.position),
                      (t.scale = 0.3),
                      t.runAction(
                        cc.sequence(cc.scaleTo(0.5, 1.1), cc.fadeOut(0.5))
                      );
                  }, 300 * n);
              }),
              (t.prototype.addScoreEffect = function () {
                ...
                (e.position = cc
                  ...
                  e.runAction(cc.spawn(cc.moveBy(0.5, 0, 50), cc.fadeOut(0.5)));
              }),
              c([m(cc.Prefab)], t.prototype, "starPre", void 0),
              c([m(cc.Node)], t.prototype, "Arrow", void 0),
              c([m(cc.Prefab)], t.prototype, "prefabStrArr", void 0),
              (t = c([h], t))
            );
          })(cc.Component);
          ...
          goToCover: function (e, t, n, o, c) {
            ...
            (a = null == a || void 0 == a || e),
              ...
              a && a
                ...
                : (this.needShow = !1),
              this.needShow
                ? (void 0 == preloader && this.startGoToGame(n, o, c),
                  (resCompleteFlag = !0),
                  adCompleteFlag &&
                    resCompleteFlag &&
      ...
      function (e, t, n) {
        ...
        cc.Class({
              ...
              function (t) {
                if (o.GAME_OVER_BOOL && o.noTouchBool)
                  return (
                    ...
                    o.gameScore >= 2 &&
                      ((this.lastPos = t.getLocation()), e.gameEnd()),
                    !0
                  );
              },
              this
          ...
          gameEnd1: function () {
            ...
            1 == t
              ? ((this.gameOverT1.string = "\u6e38 \u620f \u7ed3 \u675f"),
                (this.gameOverT2.string =
                  "\u70b9 \u51fb \u67e5 \u770b \u5206 \u6570"))
              : 2 == t
              ? ((this.gameOverT1.string = "\u904a \u6232 \u7d50 \u675f"),
                (this.gameOverT2.string =
                  "\u9ede \u64ca \u67e5 \u770b \u5206 \u6578"))
              : 4 == t
              ? ((this.gameOverT1.string = "\uac8c\uc784 \uc885\ub8cc"),
                (this.gameOverT2.string =
                  "\ud074\ub9ad \ud558\uc5ec \uc810\uc218 \ubcf4\uae30"))
              ...
              this.gameOverT1.node.runAction(
                cc.sequence(
                  cc.delayTime(0.2),
                  cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)),
                  cc.delayTime(0.3)
                )
              ),
              ...
              this.gameOverT2.node
                .runAction(
                  cc.sequence(
                    cc.delayTime(2),
                    cc.scaleTo(0.3, 1.2).easing(cc.easeSineInOut()),
                    cc.scaleTo(0.3, 1).easing(cc.easeSineInOut())
                  )
                )
                .repeatForever();
          },
          ...
          gameOverGoToOVer: function () {
            this.gameOveEndBool &&
              ...
              this.gameOverNum >= 900 &&
                ((this.gameOverNum = 0), (this.gameOveEndBool = !1)));
          },
          SetScore: function (e) {
            o.gameScore = e;
          },
            ...
            return (
              ...
              (t.prototype.start = function () {
                ...
                this.ShowScorePanel(),
                  s.default.Instance.GetLevel() % 5 == 1
                    ? ((this.passlevelYQ = 0.12), (this.lerpCtrl = !0))
                    : s.default.Instance.GetLevel() % 5 == 2
                    ? ((this.passlevelYQ = 0.31), (this.lerpCtrl = !0))
                    : s.default.Instance.GetLevel() % 5 == 3
                    ? ((this.passlevelYQ = 0.51), (this.lerpCtrl = !0))
                    : s.default.Instance.GetLevel() % 5 == 4
                    ? ((this.passlevelYQ = 0.71), (this.lerpCtrl = !0))
                    : s.default.Instance.GetLevel() % 5 == 0 &&
                      ((this.passlevelYQ = 1), (this.lerpCtrl = !0)),
                  cc
                    .tween(this.adsButton)
                    .call(function () {
                      e.adsButton.children[0].getComponent(
                        cc.Sprite
                      ).spriteFrame = u.default.Instance.adsbutton[0];
                    })
                    .delay(0.5)
                    .call(function () {
                      e.adsButton.children[0].getComponent(
                        cc.Sprite
                      ).spriteFrame = u.default.Instance.adsbutton[1];
                    })
                    .delay(0.5)
                    .union()
                    .repeatForever()
                    ...
                    (this.levelPanel.children[2].runAction(
                      cc.sequence(
                        ...
                        cc.callFunc(function () {
                          (e.level += 1),
                            (e.nowYQ = 0),
                            (e.passlevelYQ = 50 * e.level);
                        })
                      )
                    ),
                    r.default.Instance.Play(0, !1, 1),
                    i.default.Instance.ShootFlower());
              }),
              (t.prototype.showLevelProgressInfo = function () {
                (this.levelPanel.children[1].children[0].getComponent(
                  ...
                  (this.levelPanel.children[0].children[0].getComponent(
                    cc.Sprite
                  ).fillRange = 0),
                  (this.lerpCtrl = !1);
              }),
              ...
              (t.prototype.lerpNumFunc1 = function () {
                (this.levelProgress.children[0].children[0].getComponent(
                  ...
                  this.levelProgress.children[0].children[0].getComponent(
                    ...
                    ((this.relerpCtrl = !1), this.showLevelProgressInfo());
              }),
              ...
              (t.prototype.SetScore = function (e) {
                ...
                (this.scoreLabel.node.children[1].x = 60 + 25 * t),
                  e < 1e3
              ...
              (t.prototype.InjuredEffect = function () {
                (this.injuredPanel.active = !0),
                  this.injuredPanel.runAction(
                    cc.sequence(cc.fadeTo(0.1, 150), cc.fadeTo(0.1, 0))
                  );
              }),
              (t.prototype.HideScorePanel = function () {
                this.scorePanel.runAction(cc.moveBy(0.5, 0, 250)),
                  this.levelPanel.runAction(cc.moveBy(0.5, 0, 250)),
                  this.levelProgress.runAction(cc.moveBy(0.5, 0, 250)),
                  this.heartPanel.runAction(cc.moveBy(0.5, 0, 250));
              }),
              (t.prototype.ShowScorePanel = function () {
                var e = this.node.children[0].position;
                this.scorePanel.runAction(
                  cc
                    .moveTo(0.5, cc.v2(this.scorePanel.x, e.y - 20))
                    .easing(cc.easeBackOut())
                ),
                  this.levelPanel.runAction(
                    cc.moveTo(0.5, e).easing(cc.easeBackOut())
                  ),
              ...
              (t.prototype.showCongratulation = function () {
                var e = this;
                r.default.Instance.Play(1, !1, 1),
                  (a.default.GameUpdateCtrl = !1),
                  (this.congratulation.active = !0),
                  (this.player.getComponent(cc.PolygonCollider).enabled = !1),
                  (this.congratulation.children[1].children[2].getComponent(
                    cc.Label
                  ).string = a.default.score.toString()),
              ...
              (t.Instance = null),
              c([f(cc.Node)], t.prototype, "mainCamera", void 0),
              c([f(cc.Node)], t.prototype, "bgLayer", void 0),
              c([f(cc.Label)], t.prototype, "scoreLabel", void 0),
              c([f(cc.Node)], t.prototype, "scorePanel", void 0),
              c([f(cc.Node)], t.prototype, "guidePanel", void 0),
              c([f(cc.Node)], t.prototype, "injuredPanel", void 0),
              c([f(cc.Node)], t.prototype, "levelPanel", void 0),
              c([f(cc.Node)], t.prototype, "levelProgress", void 0),
              c([f(cc.Node)], t.prototype, "heartPanel", void 0),
              c([f(cc.Node)], t.prototype, "congratulation", void 0),
              c([f(cc.Node)], t.prototype, "adsButton", void 0),
              c([f(cc.Node)], t.prototype, "player", void 0),
              (t = n = c([p], t))
            );
          })(cc.Component);
            ...
            (e("GameUiTools"),
            {
              ...
              getHttpGameId: function () {
                ...
                (this.gameAllHttp = o),
                  ...
                  (this.subScoreHttp = t + n + "/Service/Score/index"),
                  (this.gamePvHttp = t + n + "/Service/GamePv/index");
                var c = document.URL,
                  a = 0,
                  i = c
                    .substring(c.lastIndexOf("/game/") + 1, c.length)
                    .split("/");
                i.length >= 2 && (a = i[1]),
                  (this.gameHttpId = a),
                  cc.log("gameId", a);
              ...
              ranLinkUrl: function () {
                if (
                  ...
                  var e = this.ranLinkData.gameList.length,
                    t = a.returnRanNum(1, e) - 1;
                  return (
                    cc.log("templ", t, this.ranLinkData.gameList),
                    cc.log(
                      "url",
                      this.ranLinkData.gameList[0].gameName,
              ...
              gotoEndLayer: function () {
                if (a.publicGameBool) this.showGameEndLayer();
                  ...
                  if (
                    ...
                    console.log("ad", e),
                      (e = null == e || void 0 == e || this.adShowAfter)
                        ? ((this.needShow = !0),
                    ...
                    null != this.needShow &&
                      ...
                      this.needShow
                        ? (console.log("pre", preloader),
                          void 0 == preloader && this.showGameEndLayer(),
                          (resEndComplete = !0),
                          adEndComplete &&
                            resEndComplete &&
                            (console.log("showOver1"), this.showGameEndLayer()))
                        : (console.log("gam"), this.showGameEndLayer()));
                }
              },
        ...
        var a = e("../Common/PoolManager"),
          ...
          l = (function (e) {
            ...
            return (
              ...
              c([s], t.prototype, "prefabName", void 0),
              c([s], t.prototype, "gravityScale", void 0),
              c([s], t.prototype, "dropTime", void 0),
              c([s], t.prototype, "deadTime", void 0),
              c([s(cc.Vec2)], t.prototype, "velocity", void 0),
              (t = c([r], t))
            );
          })(cc.Component);
        (n.default = l), cc._RF.pop();
    ...
    PlayerInfo: [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "ea489dPDU9OZYOr2dE1HqB7", "PlayerInfo"),
          Object.defineProperty(n, "__esModule", {
            value: !0,
          });
        var o = (function () {
        ...
        var a = cc._decorator,
          ...
          s = (function (e) {
            ...
            return (
              ...
              (t.Instance = null),
              c([r([cc.Prefab])], t.prototype, "allPrefab", void 0),
              (t = n = c([i], t))
            );
          })(cc.Component);
        (n.default = s), cc._RF.pop();
          ...
          u = (function (e) {
            function t() {
              ...
              return (
                ...
                (t.isUpdate = !0),
                (t.turnNum = 0),
                (t.mosquitoSpeedLen = 2),
                (t.mosquitoSpeedMaxR = 4),
                (t.mosquitoSpeedR = 0),
                (t.mosquitoTargetR = 0),
                (t.mosquitoTargetMaxR = 359),
                (t.mosquitoAddR = !0),
                (t.checkEdgeDelayCount = 0),
                (t.newPos = cc.v2(0, 0)),
                (t.dir = cc.v2(0, 1)),
                (t.fadeTime = 0),
                (t.fadeTicker = 1),
            ...
            return (
              ...
              (t.prototype.SetId = function (e) {
                ...
                (this.wing_l.getComponent(cc.Sprite).spriteFrame = t),
                  (this.wing_r.getComponent(cc.Sprite).spriteFrame = t),
                  (this.body.getComponent(cc.Sprite).spriteFrame = n);
              }),
              (t.prototype.startFun = function () {
                this.wing_r.stopAllActions(),
                  this.wing_l.stopAllActions(),
                  this.wingAction(),
                  (this.isUser = !0),
                  (this.isUpdate = !0),
                  (this.turnNum = i.default.Random(10, 20)),
                  (this.mosquitoSpeedR = 0),
                  (this.mosquitoTargetR = 0),
                  (this.mosquitoTargetMaxR = 359),
                  (this.mosquitoAddR = !0),
                  (this.mapScale = 1),
                  (this.onEdgeFlag = !0),
                  (this.isTurn = !0),
                ...
                this.wing_r.runAction(
                  cc.repeatForever(
                    cc.sequence(
                      ...
                      cc.scaleTo(0.2, 0.4, 1).easing(cc.easeSineInOut())
                    )
                  )
                ),
              ...
              (t.prototype.setMosquitoSpeed = function () {
                this.node.angle >= 360
                  ? (this.node.angle -= 360)
                  : this.node.angle < 0 && (this.node.angle += 360),
                  (this.mosquitoSpeedR =
                    Math.random() * this.mosquitoSpeedMaxR * 2 -
                    this.mosquitoSpeedMaxR);
                var e =
                  Math.random() *
                  this.mosquitoTargetMaxR *
                  (Math.abs(this.mosquitoSpeedR) /
                    (this.mosquitoSpeedMaxR + 0.4 * this.mapScale));
                this.mosquitoSpeedR > 0
                  ...
                  this.onEdgeFlag &&
                    ...
                    ((this.mosquitoSpeedR = (this.mosquitoSpeedR / 3) * 2),
                    (this.mosquitoTargetR = (this.mosquitoTargetR / 3) * 2)),
                  (this.onEdgeFlag = !1),
                  this.turnNum--,
                  this.turnNum <= 0 && (this.isTurn = !1);
              }),
              (t.prototype.updateMosquito = function () {
                var e = this.mosquitoSpeedLen,
                  ...
                  o = this.node,
                  c = this.getPointByCPAndAngleAndLen(
                    o.getPosition(),
                    o.angle + t,
                    e
                  );
                o.setPosition(c),
                  (o.angle += t),
                  this.mosquitoAddR
                    ? o.angle >= n && this.setMosquitoSpeed()
                    : o.angle <= n && this.setMosquitoSpeed();
              }),
              ...
              (t.prototype.update = function (e) {
                this.isUpdate &&
                  this.isUser &&
                  (this.updateMosquito(), this.checkOnEdge(!0)),
                  this.isFade ||
                    ((this.fadeTicker -= e),
                    this.fadeTicker < 0 &&
                      ((this.fadeTicker = 0),
              ...
              c([l], t.prototype, "id", void 0),
              c([l(cc.Node)], t.prototype, "wing_r", void 0),
              c([l(cc.Node)], t.prototype, "wing_l", void 0),
              c([l(cc.Node)], t.prototype, "body", void 0),
              c([l], t.prototype, "mosquitoSpeedLen", void 0),
              c([l], t.prototype, "mosquitoSpeedMaxR", void 0),
              c([l], t.prototype, "fadeTime", void 0),
              (t = c([s], t))
            );
          })(cc.Component);
          ...
          s = (function (e) {
            ...
            return (
              ...
              (t.prototype.onLoad = function () {
                ...
                t.setTexture(e),
                  (this.waterCamera.targetTexture = e),
                  (this.waterConnect.spriteFrame = t);
              }),
              (t.prototype.createWater = function () {
                ...
                for (var e = 0; e < 50; e++) {
                  ...
                  t ||
                    ((t = cc.instantiate(this.prefab_water)),
              ...
              (t.prototype.scheduleWater = function () {
                this.waterParent.children[
                  this._waterGenrateCount++
                ].active = !0;
              }),
              (t.prototype.resetWater = function () {
                var e = this;
                this.unschedule(this.scheduleWater),
                  this.waterParent.children.forEach(function (t) {
                    (t.active = !1), e._water_pool.push(t);
                  });
              }),
              c([r(cc.Camera)], t.prototype, "waterCamera", void 0),
              c([r(cc.Sprite)], t.prototype, "waterConnect", void 0),
              c([r(cc.Node)], t.prototype, "waterParent", void 0),
              (t = c([i], t))
            );
          })(cc.Component);
        (n.default = s), cc._RF.pop();
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                if (this.isRotating && this.targetPos) {
                  ...
                  if (
                    ((this.node.x =
                      this.targetPos.x + this.radius * Math.cos(t)),
                    (this.node.y =
                      this.targetPos.y + this.radius * Math.sin(t)),
                    this.faceToTarget)
                  )
                  ...
                  this.clockwise ? (this.angle -= n) : (this.angle += n),
                    this.angle >= 360
                      ? (this.angle %= 360)
              ...
              (t.prototype.run = function (e, t, n, o, c) {
                ...
                this.ischangeFunc
                  ? this.node.y > 0
                    ? (this.angle =
                        this.getAngle(this.targetPos, this.node.getPosition()) +
                        90)
                    : (this.angle =
                        this.getAngle(this.targetPos, this.node.getPosition()) -
                        90)
                ...
                (this.node.x = this.targetPos.x + this.radius * Math.cos(a)),
                  (this.node.y = this.targetPos.y + this.radius * Math.sin(a)),
                  (this.isRotating = !0);
              }),
      ...
      function (e, t, n) {
        ...
        var o = cc.ActionInterval.extend({
          ...
          update: function (e) {
            ...
            (this.xOffset += t),
              (this.yOffset += n),
              this.target.setPosition(this.target.position.add(cc.v2(t, n)));
          },
          initWithDuration: function (e, t, n) {
            return (
              !!cc.ActionInterval.prototype.initWithDuration.call(this, e) &&
              ((this.nodeShakeStrengthX = t),
              (this.nodeShakeStrengthY = "undefined" == n ? t : n),
              !0)
            );
          },
        ...
        var a = cc._decorator,
          ...
          s = (function (e) {
            ...
            return (
              ...
              (t.Instance = null),
              c([r(cc.SpriteAtlas)], t.prototype, "atlas", void 0),
              c([r(cc.SpriteFrame)], t.prototype, "allSpriteFrame", void 0),
              (t = n = c([i], t))
            );
          })(cc.Component);
        (n.default = s), cc._RF.pop();
    ...
    Stack: [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "17b226CrNJGGYSBKYckUg+j", "Stack"),
          Object.defineProperty(n, "__esModule", {
            value: !0,
          });
        var o = (function () {
    ...
    Toast: [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "4f5a7oIt7pFWaaZNA1+j7MV", "Toast"),
          Object.defineProperty(n, "__esModule", {
            value: !0,
          });
        var o = (function () {
          function e() {
            ...
            (n.resizeMode = cc.Layout.ResizeMode.CONTAINER),
              ...
              (this.textLabel.fontSize = 50),
              (this.textLabel.lineHeight = 50);
          }
            ...
            (e.prototype.showText = function (e, t) {
              ...
              void 0 === t && (t = 0.5),
                e.length * this.textLabel.fontSize >
                  ...
                  (this.textLabel.node.width = 0.8 * this.canvas.node.width)),
                (this.textLabel.string = e),
                (this.toastNode.active = !0),
                (this.toastNode.opacity = 200),
                this.toastNode.runAction(
                  cc.sequence(
                    cc.delayTime(t),
                    cc.fadeOut(0.2),
                    cc.callFunc(function () {
        ...
        var o = {
          ...
          getStorage: function (e, t) {
            ...
            return (
              ...
              "NaN" == n.toString() && (n = null),
              t && null != n && (n = JSON.parse(n)),
              n
            );
          },
            ...
            if (cc.sys.isBrowser) {
              ...
              (o.download = t),
                ...
                null != window.webkitURL
                  ? (o.href = window.webkitURL.createObjectURL(n))
          ...
          newSprite: function (e) {
            if (null != this.SpriteFrameJs.getSpriteFrame(e)) {
              ...
              return (
                (t.addComponent(
                  cc.Sprite
                ).spriteFrame = this.SpriteFrameJs.getSpriteFrame(e)),
                t
              );
            }
            return null;
          ...
          setTexture: function (e, t) {
            e.getComponent(
              cc.Sprite
            ).spriteFrame = this.SpriteFrameJs.getSpriteFrame(t);
          },
          clonePrefabs: function (e, t, n) {
            ...
            if (null != c) {
              ...
              return (
                null != t && t.addChild(a, o), null != n && (a.position = n), a
              );
            }
            return (
              console.log("\u514b\u9686\u9884\u5236\u4f53\u5931\u8d25:" + e),
              null
            );
          },
          ...
          newAduioSource: function (e) {
            ...
            var n = new cc.Node();
            return (
              (n.addComponent(cc.AudioSource).clip = t),
              n.getComponent(cc.AudioSource)
            );
          },
          ...
          isRectInterRect: function (e, t) {
            return e
              ...
              .intersects(t.getBoundingBoxToWorld());
          },
    ...
    Utils: [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "f3369tYECpPVJGWDo7sIHaO", "Utils"),
          Object.defineProperty(n, "__esModule", {
            value: !0,
          });
        var o = (function () {
          ...
          return (
            (e.getBezierPos = function (e, t) {
              ...
              for (var c = this.getYangHuiTriangle(o), a = 0; a < t; a++) {
                for (var i = a / t, r = 0, s = 0, l = 0; l < o; l++)
                  (r +=
                    Math.pow(1 - i, o - l - 1) *
                    e[l].x *
                    Math.pow(i, l) *
            ...
            (e.ConvertScale = function (e, t) {
              for (var n = e.parent, o = e.scaleX, c = e.scaleY; null != n; )
                (o *= n.scaleX), (c *= n.scaleY), (n = n.parent);
              for (var a = t.parent, i = t.scaleX, r = t.scaleY; null != a; )
                (i *= a.scaleX), (r *= a.scaleY), (a = a.parent);
              var s = o;
              0 != i && (s /= i);
              var l = c;
            ...
            (e.CheckPolygonNodeCollision = function (t, n) {
              ...
              for (i = 0; i < a.length; i++)
                a[i].rotateSelf(e.AngleToRadian(t.angle)), (a[i] = l.add(a[i]));
              var u = n.convertToWorldSpaceAR(cc.v2(0, 0));
              (u = cc.find("Canvas").convertToNodeSpaceAR(u)), (u = n.position);
              for (i = 0; i < s.length; i++)
                s[i].rotateSelf(e.AngleToRadian(n.angle)), (s[i] = u.add(s[i]));
            ...
            (e.RandomIndexFromArr = function (e) {
              for (
                var t = new Array(), n = new Array(), o = 0, c = 0;
                c < e.length;
                c++
              )
                e[c] > 0 && (t.push(e[c]), n.push(c), (o += e[c]));
              var a = 100 / o;
              for (c = 0; c < t.length; c++)
            ...
            (e.cbPosToWorldPos = function (e, t, n, o, c, a) {
              var i = n + (e.x - t.x / 2 + 0.5) * c,
                r = o + (e.y + 0.5) * a;
              return cc.v2(i, r);
            }),
            (e.worldPosToCbPos = function (e, t, n, o, c, a) {
              var i = (e.x - n) / c - 0.5 + t / 2,
                r = (e.y - o) / a - 0.5;
              return (
                (i % 1 == 0 && r % 1 == 0) ||
            ...
            (e.judgeIntersect = function (e, t, n, o, c, a, i, r) {
              return (
                Math.min(e, n) <= Math.max(c, i) &&
                Math.min(a, r) <= Math.max(t, o) &&
            ...
            (e.getCircumferencePos = function (e, t, n) {
              var o = cc.v2(0, 0);
              return (
                (o.x = e.x + Math.sin(((2 * Math.PI) / 360) * n) * t),
            ...
            (e.getNodePos = function (e, t, n) {
              return n
                ? e.convertToNodeSpaceAR(t.convertToWorldSpaceAR(n))
                : e.convertToNodeSpaceAR(t.convertToWorldSpaceAR());
            }),
            ...
            (e.judgeArrSame = function (e, t) {
              for (var n = 0; n < e.length; n++)
                for (var o = 0; o < t.length; o++) if (e[n] !== t[o]) return !1;
              return !0;
            }),
            ...
            (e.getBoundingBoxToNode = function (e, t) {
              var n = t.convertToNodeSpaceAR(
                e.convertToWorldSpaceAR(
                  cc.v2(
                    -e.anchorX * e.width * (e.scaleX / Math.abs(e.scaleX)),
                    -e.anchorY * e.height * (e.scaleY / Math.abs(e.scaleY))
                  )
                )
              );
              return cc.rect(
                n.x,
                n.y,
                e.width * Math.abs(e.scaleX),
                e.height * Math.abs(e.scaleY)
              );
            }),
        ...
        var a = cc._decorator,
          ...
          s = (function (e) {
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                if (
                  this.leftUpWall.y - this.mainCamera.y >
                  this.leftUpWall.height
                ) {
                  this.leftUpWall.y =
                    this.leftDownWall.y - this.leftDownWall.height;
                ...
                if (
                  ...
                  this.rightUpWall.height
                ) {
                  this.rightUpWall.y =
                    this.rightDownWall.y - this.rightDownWall.height;
                  t = this.rightUpWall;
              ...
              c([r(cc.Node)], t.prototype, "leftUpWall", void 0),
              c([r(cc.Node)], t.prototype, "leftDownWall", void 0),
              c([r(cc.Node)], t.prototype, "rightUpWall", void 0),
              c([r(cc.Node)], t.prototype, "rightDownWall", void 0),
              (t = c([i], t))
            );
          })(cc.Component);
        (n.default = s), cc._RF.pop();
    ...
    bfPrefabJs: [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "813eeXgvcJG96hqXhg+nvJ0", "bfPrefabJs"),
          cc.Class({
            extends: cc.Component,
            properties: {
              wing_r: cc.Node,
            ...
            startFun: function () {
              this.wing_r.stopAllActions(),
                ...
                (this.isUser = !0),
                (this.isUpdate = !0),
                (this.turnNum = other.randomInt(10, 20)),
                (this.mosquitoSpeedLen = 2),
                (this.mosquitoSpeedMaxR = 4),
                (this.mosquitoSpeedR = 0),
                (this.mosquitoTargetR = 0),
                (this.mosquitoTargetMaxR = 359),
                (this.mosquitoAddR = !0),
            ...
            updateMosquito: function () {
              var e = this.mosquitoSpeedLen,
                ...
                n = this.mosquitoTargetR,
                c = this.node,
                a = o.getPointByCPAndAngleAndLen(
                  c.getPosition(),
                  c.angle + t,
                  e
                );
              ...
              this.isUpdate &&
                (this.isUser
                  ? this.isTurn
                    ? (this.updateMosquito(), this.checkOnEdge(!0))
                    : this.updateMove(e)
                  : (this.updateMove_1(e), this.checkOnEdge(!1)));
            },
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                ...
                if (
                  (this.node.x < -this.bianjieX &&
                    (this.node.x = -this.bianjieX),
                  this.node.x > this.bianjieX && (this.node.x = this.bianjieX),
                  ...
                  this.node.y + this.node.width / 2 >
                    cc.find("Canvas/lineNode").children[0].y &&
                  ...
                  for (
                    var n = 0;
                    n < cc.find("Canvas/fruitNode").children.length;
                    n++
                  )
                    cc
                      .find("Canvas/fruitNode")
                      .children[n].removeComponent(cc.PhysicsCircleCollider),
                      cc
                        .find("Canvas/fruitNode")
                        .children[n].removeComponent(cc.RigidBody);
                    ...
                    cc
                      ...
                      .call(function () {
                        i.default.Instance.end(),
                          (cc.find("Canvas/lineNode").children[0].active = !1);
                      })
                      .start(),
                    this.endOne++;
                }
              ...
              (t.prototype.onBeginContact = function (e, t, n) {
                ...
                if (
                  ...
                  (t.node.parent = cc.find("Canvas/fruitNode")),
                    ...
                    null != t.node.getComponent(cc.RigidBody) &&
                      (t.node.getComponent(cc.RigidBody).angularVelocity = 0);
                  ...
                  c == r && c < 9 && r < 9
                    ? ((this.pengzhuangCount += 1),
                      0 == t.node.getComponent("fruitData").getNumber() &&
                          ...
                          .call(function () {
                            ...
                            (e.active = !0),
                              ...
                              cc
                                ...
                                .start();
                            var c = new cc.Node();
                            (c.addComponent(cc.Sprite).spriteFrame =
                              l.default.Instance.fruit[10]),
                              (c.parent = cc.find("Canvas/upEffectParent")),
                              (c.position = cc.v2(0, -500)),
                              (c.scale = 0);
                            var r = new cc.Node();
                            (r.addComponent(cc.Sprite).spriteFrame =
                              ...
                              cc
                                ...
                                .start();
                            var s = new cc.Node();
                            (s.addComponent(cc.Sprite).spriteFrame =
                              l.default.Instance.fruit[10]),
                              (s.parent = c),
                              (s.position = cc.v2(0)),
                              ...
                              c.runAction(
                                cc.sequence(
                                  cc.spawn(
                                    cc.jumpBy(1, 0, 0, 300, 1),
                                    cc.scaleTo(1, 1)
                                  ),
                                  cc.delayTime(1),
                                  cc.spawn(
                                    cc.moveTo(1, cc.v2(0, 500)),
                                    cc.scaleTo(1, 0)
                                  ),
                                  cc.callFunc(function () {
                                    (a.default.score += 100),
              ...
              (t.prototype.createBoom = function () {
                ...
                (e.position = this.node.position),
                  e.runAction(cc.sequence(cc.delayTime(0.5), cc.fadeOut(0.5)));
              }),
              (t.prototype.createStar = function () {
                var e = r.default.Spawn(
                  "star",
      ...
      function (e, t, n) {
        ...
        cc.Class({
          ...
          UIPosChange: function () {
            ...
            (e =
              1 == a.langugeType
                ? this.getContentByScore(c.gameScore, a.gameNameText)
                : this.getContentByScore2(c.gameScore, a.gameNameText)),
            ...
            if (
              ...
              (this.rigthBtnGameName = o),
                (this.rightBtnGameUrl = a.ranLinkData.gameList[n].gameUrl);
            }
            null != this.rigthBtnGameName && "" != this.rigthBtnGameName
          ...
          addClickBtns: function () {
            ...
            e.moreBtn.node.on(cc.Node.EventType.TOUCH_START, function (e) {}),
              ...
              e.rightBtn.node.on(cc.Node.EventType.TOUCH_END, function (t) {
                var n = null;
                (n =
                  null != e.rightBtnGameUrl && "" != e.rightBtnGameUrl
                    ? e.rightBtnGameUrl
                    : e.tempArr[1]),
          ...
          getContentByScore: function (e, t) {
            ...
            if (e > 0 && e <= o)
              ...
              n =
                ...
                "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" +
                (Math.floor(
                  (12 * (e - this.standardScore)) / (c - this.standardScore)
                ) +
                  80) +
                "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u4fe1\u624b\u62c8\u6765\u7684\u5883\u754c\uff01";
            } else if (e > c && e <= a) {
              ...
              n =
                ...
                e +
                "\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 " +
                (20 - Math.ceil((17 * (e - i)) / (this.game_max_score - i))) +
                "\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff0c\u72ec\u5b64\u6c42\u8d25\uff01";
            } else
        ...
        cc.Class({
            ...
            if (
              ...
              null != o.recGamePos &&
                ...
                (1 == o.recGamePos
                  ? ((e = 50 - this.gameWidth / 2),
                    (t = this.gameHeight - 50 - this.gameHeight / 2))
                  : 2 == o.recGamePos
                  ? ((e = this.gameWidth - 50 - this.gameWidth / 2),
                    (t = this.gameHeight - 50 - this.gameHeight / 2))
                  : 3 == o.recGamePos
                  ? ((e = this.gameWidth - 50 - this.gameWidth / 2),
              ...
              cc.loader.load(n, function (n, o) {
                ...
                cc.loader.load(c, function (n, o) {
                  (i.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(
                    o
                  )),
          ...
          showLinkPic: function () {
            ...
            (e = null != o.recGameDelPau ? o.recGameDelPau : 6),
              ...
              (t = null != o.recGameDelPer ? o.recGameDelPer : 0.7),
                    ...
                    i <= 30 &&
                      ...
                      null != o.recGameUrl &&
                        ...
                        e._imageArr[1].runAction(
                          cc.sequence(cc.scaleTo(0.1, 0.8), cc.scaleTo(0.1, 1))
                        )),
            ...
            return (
              ...
              (t.prototype.start = function () {
                (this.shellNode = cc.find("Canvas/shellNode")),
                  (this.player = cc.find("Canvas/playerNode/player")),
                  (this.node.scale = 0.7);
              }),
              (t.prototype.update = function (e) {
                if (i.default.GameUpdateCtrl) {
                  ...
                  (this.node.angle = -n),
                    ...
                    this.shootTime >= this.shootInter &&
                      (this.shootShell(), (this.shootTime = 0));
                }
              }),
              (t.prototype.shootShell = function () {
                this.node.runAction(
                  cc.sequence(
                    cc.scaleTo(0.1, 0.7, 0.5),
                ...
                e.runAction(cc.scaleTo(0.2, 0.5)),
                  e.runAction(
                    cc.sequence(
                      cc.moveBy(10, 2e3 * t.x, 2e3 * t.y),
                      cc.callFunc(function () {
              ...
              (t.prototype.onCollisionEnter = function (e, t) {
                ...
                2 == e.node.getComponent("shellData").shellLife
                  ? (e.node.getComponent("shellData").shellLife -= 1)
                  : "shell" == e.node.group &&
                    1 == e.node.getComponent("shellData").shellLife &&
                    (u.default.Instance.Play(2, !1, 1),
                    (t.node.active = !1),
                    (s.default.Instance.cannonNodeArr[this.cannonNumber] = 0),
                    this.createCannonSui(t.node),
                    e.node.stopAllActions(),
                    (i.default.score += 10),
                    l.default.Instance.SetScoreTween(i.default.score),
                  ...
                  t.children[n].runAction(
                    cc.sequence(
                      cc.spawn(
                        cc.moveBy(
                          0.25,
                          a.default.RandomInteger(-70, 70),
                          a.default.RandomInteger(-70, 70)
                        ),
                        cc.rotateBy(0.5, a.default.RandomInteger(-360, 360))
                      ),
                      cc.fadeOut(1),
                      cc.callFunc(function () {
                        t.destroy();
              ...
              c([f(cc.Prefab)], t.prototype, "peaSuiPre", void 0),
              (t = c([p], t))
            );
          })(cc.Component);
        (n.default = h), cc._RF.pop();
          ...
          cc.Class({
            ...
            playAudio: function (e) {
              ...
              return null != this.audioClipDic[e]
                ? cc.audioEngine.play(this.audioClipDic[e], n, t)
                : (console.log(
                    "\u6ca1\u6709\u627e\u5230\u97f3\u9891\uff1a" + e
                  ),
                  null);
            ...
            return (
              ...
              (t.prototype.onLoad = function () {
                this.startPanel.setContentSize(
                  ...
                  this.startPanel.children[0].children[0].setContentSize(
                    cc.winSize.width,
                    cc.winSize.height
                  );
              }),
              (t.prototype.start = function () {
                (this.startPanel.children[1].scaleX = 0),
                  this.startPanel.children[1].runAction(
                    cc.scaleTo(0.5, 0.9).easing(cc.easeBackOut())
                  ),
              ...
              (t.prototype.initTitle = function () {
                ...
                1 != e &&
                  (this.titleSpr.getComponent(
                    cc.Sprite
                  ).spriteFrame = this.title[e - 1]),
                  this.initTitleAni();
              }),
              ...
              c([l(cc.Node)], t.prototype, "startPanel", void 0),
              c([l(cc.Node)], t.prototype, "titleSpr", void 0),
              c([l(cc.Node)], t.prototype, "startBtn", void 0),
              c([l(cc.SpriteFrame)], t.prototype, "title", void 0),
              (t = c([s], t))
            );
          })(cc.Component);
        (n.default = u), cc._RF.pop();
    ...
    "use_v2.1.x_cc.Action": [
      function (e, t, n) {
        "use strict";
        cc._RF.push(t, "ce2acozQx1Dq7kOhKg5RkBi", "use_v2.1.x_cc.Action"),
        ...
        var a = e("../common/PlayerInfo"),
          ...
          h = (function (e) {
            ...
            return (
              ...
              (t.prototype.start = function () {}),
              (t.prototype.update = function (e) {
                this.isMove && (this.node.x += l.default.Instance.lvdaiSpeed),
                  this.node.x >= 500 &&
                    i.default.Despawn(this.node.name, this.node);
              }),
              (t.prototype.onCollisionEnter = function (e, t) {
                "wine" == e.node.group &&
                  ...
                  a.default.playerTouch &&
                    (u.default.Instance.ToEnd(), (a.default.playerTouch = !1)));
              }),
                  ...
                  t.children[n].runAction(
                    cc.spawn(
                      cc.sequence(
                        cc.jumpBy(
                          1,
                          r.default.RandomInteger(-500, 50),
                          r.default.RandomInteger(-2e3, -1600),
                          500,
                          1
                        ),
                        cc.fadeOut(0.5)
                      ),
                      cc.rotateBy(1, r.default.RandomInteger(-860, 860))
                    )
                  );
              }),
              (t.prototype.createWineSa = function (e) {
                for (
                  var t = r.default.RandomInteger(35, 40), n = 0;
                  n < t / 2;
                  n++
                ) {
                  ((o = i.default.Spawn(
                    ...
                    o.runAction(
                      cc.spawn(
                        cc.jumpBy(
                          1,
                          r.default.RandomInteger(-300, 50),
                          r.default.RandomInteger(-400, -200),
                          r.default.RandomInteger(100, 150),
                          1
                        ),
                        cc.fadeOut(1)
                      )
